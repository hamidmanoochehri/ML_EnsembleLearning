...
def bagging(T, df_train,df_test, max_depth, Entropy_method,att_barnches):
    #train
    h_list=[]
...
error_test, error_train=bagging(T, df_train_m,df_test_M, max_depth, Entropy_method,att_barnches)
#p1=mp.Process(target=bagging, args=(T_list,df_train_m,df_test_M,max_depth, Entropy_method,att_barnches))
#p1.start()
